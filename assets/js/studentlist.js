...
const array = [
  ...
  
    {
      ...
      dept: 'Make-up',
      phone: '(090) 210-64577',
      address: '9, maxewell ijehe Sanya, Itire/ Ikate',
  ...
  
    {
      ...
      dept: 'Make-up',
      phone: '(090) 163-50516',
      address: '3 Obasola Ajijola AvenueAirways , Itire/ Ikate',
  ...
  
    {
      ...
      dept: 'Make-up',
      phone: '(081) 281-28170',
      address: '16, Shobande streetKaronwi-ogunsanmi , Itire-ikate',
      weeklyAttendance: 9.0,
      softSkillAttendance: 10,
      test: 8.5,
      softSkillProject: 13,
  ...
  
    {
      ...
      dept: 'Make-up',
      phone: '(091) 607-50462',
      address: '2 Alade closeOdo-Olowu, Itire /Ikate',
  ...
  
    {
      ...
      dept: 'Make-up',
      phone: '(080) 894-19908',
      address: '24 adamolekun street Odo-Olowu, Itire/ Ikate',
      weeklyAttendance: 9.0,
      softSkillAttendance: 10,
      test: 11.5,
      softSkillProject: 12,
  ...
  
    {
      ...
      dept: 'Make-up',
      phone: '(070) 652-04426',
      address: '17, Erelu Oanisa street Airways, Itire/ Ikate',
      weeklyAttendance: 9,
      softSkillAttendance: 10,
      test: 14.5,
  ...
  
    {
      ...
      dept: 'Make-up',
      phone: '(090) 188-10790',
      address: '100, lawanson Rd off Ramoni BustopBaruwa, Itire-Ikate',
  ...
  
    {
      ...
      dept: 'Make-up',
      phone: '(070) 823-35309',
      address: '73b Oshogbo Street Agunbiade , ItireIkate',
  ...
  
    {
      ...
      dept: 'Make-up',
      phone: '(081) 793-79031',
      address: '3 Omonubi StreetAgunbiade, Itire-Ikate',
      weeklyAttendance: 10,
      softSkillAttendance: 10,
      test: 12.5,
      softSkillProject: 11.75,
  ...
  
    {
      ...
      dept: 'Make-up',
      phone: '(080) 232-68095',
      address: '21 Adeosun street Ramoni, Itire / Ikate',
      weeklyAttendance: 6.0,
      softSkillAttendance: 0,
      test: 11.5,
      softSkillProject: 0,
  ...
  
    {
      ...
      dept: 'Make-up',
      phone: '(080) 321-26457',
      address: '2B Temidire street ItireRamoni, Itire-Ikate',
  ...
  
    {
      ...
      dept: 'Make-up',
      phone: '(070) 480-30439',
      address: '8 Jinadu street Sanusi, Itire/ikate',
      weeklyAttendance: 8.5,
      softSkillAttendance: 0,
      test: 9.5,
      softSkillProject: 0,
    ...
    
    {
      ...
      dept: 'Make-up',
      phone: '(080) 979-14926',
      address: '37 Orowunmi streetSavage, Coker-Aguda',
  ...
  
    {
      ...
      dept: 'Make-up',
      phone: '(091) 662-64173',
      address: '23, Savana Street off Adetola AgudaCoker, Coker-Aguda',
  ...
  
    {
      ...
      dept: 'Make-up',
      phone: '(080) 841-89246',
      address: '32 Adedoyin street off omilaniAgunbiade, Itire-Ikate',
      weeklyAttendance: 8.75,
      softSkillAttendance: 10,
      test: 6,
      softSkillProject: 17.25,
  ...
  
    {
      ...
      dept: 'Make-up',
      phone: '(080) 890-88904',
      address: '43, Olayinka StreetKaronwi-Ogunsanmi, Itire-Ikate',
      weeklyAttendance: 9.0,
      softSkillAttendance: 10,
      test: 15.5,
      softSkillProject: 11.75,
  ...
  
    {
      ...
      dept: 'Make-up',
      phone: '(080) 659-27152',
      address: '10 Akinkunmi Street itireKaronwi-ogunsanmi, Itire-ikate',
      weeklyAttendance: 4.75,
      softSkillAttendance: 0,
      test: 17,
      softSkillProject: 17.25,
  ...
  
    {
      ...
      dept: 'Make-up',
      phone: '(080) 939-38761',
      address: '03 Ramoni street Ramoni, Itire/ Ikate',
      weeklyAttendance: 7.0,
      softSkillAttendance: 0,
      test: 12.5,
      softSkillProject: 14.13,
  ...
  
    {
      ...
      dept: 'Make-up',
      phone: '(081) 255-37784',
      address: '11 Omilani street Agunbiade , Itire/ Ikate',
  ...
  
    {
      ...
      dept: 'Make-up',
      phone: '(090) 186-26841',
      address: '210 ijesha road Odo-Olowu, Itire/ Ikate',
    ...
    { 
      ...
      dept: 'Make-up',
      phone: '(070) 374-16160',
      address: '4 Ehi street Ijeshatedo Airways , Itire/ Ikate',
      weeklyAttendance: 6.0,
      softSkillAttendance: 0,
      test: 11.5,
      softSkillProject: 0,
  ...
  
    {
      ...
      dept: 'Make-up',
      phone: '(091) 377-94321',
      address: '7 Ileogbo street Agunbiade , Itire / Ikate',
    ...
    ///////////////////////////////HAIRDRESSING DEPARTMENT//////////////////////////////////////
    {
      ...
      dept: 'Hairdressing',
      phone: '(080) 845-12552',
      address: '18 Oremeji StreetAGUNBIADE, Itire-Ikate',
      weeklyAttendance: 8.25,
      softSkillAttendance: 10,
      test: 10,
      softSkillProject: 0,
  ...
  
    {
      ...
      dept: 'Hairdressing',
      phone: '(080) 835-82895',
      address: '39, Obiosa street Sanusi , Itire/ikate',
      weeklyAttendance: 8.25,
      softSkillAttendance: 10,
      test: 16,
      softSkillProject: 14.13,
  ...
  
    {
      ...
      dept: 'Hairdressing',
      phone: '(081) 208-42551',
      address: '6 Adegbola street Baruwa ,Itire/Ikate',
      weeklyAttendance: 9.75,
      softSkillAttendance: 10,
      test: 16,
      softSkillProject: 13,
  ...
  
    {
      ...
      dept: 'Hairdressing',
      phone: '(070) 621-71688',
      address: '22, Fadahunsi Street IjeshatedoAgunbiade, Itire-Ikate',
      weeklyAttendance: 8.0,
      softSkillAttendance: 10,
      test: 18,
      softSkillProject: 14.13,
  ...
  
    {
      ...
      dept: 'Hairdressing',
      phone: '(090) 601-09811',
      address: '7, GUINNY ODUBENO STREET AGUNBIADE, Itire-Ikate',
      weeklyAttendance: 7.5,
      softSkillAttendance: 0,
      test: 14,
      softSkillProject: 0,
  ...
  
    {
      ...
      dept: 'Hairdressing',
      phone: '(090) 272-06512',
      address: '77, Adeshina Street, IjeshaAirways, Itire-Ikate',
      weeklyAttendance: 7.5,
      softSkillAttendance: 0,
      test: 7,
      softSkillProject: 15.5,
  ...
  
    {
      ...
      dept: 'Hairdressing',
      phone: '(070) 650-01229',
      address: '3, Olaitan Onasanya street Baruwa , Itire/Ikate',
      weeklyAttendance: 6.5,
      softSkillAttendance: 10,
      test: 7,
      softSkillProject: 12,
  ...
  
    {
      ...
      dept: 'Hairdressing',
      phone: '(081) 838-13551',
      address: '6, Adegbola street , SurulereBaruwa, Itire/ Ikate',
      weeklyAttendance: 10,
      softSkillAttendance: 10,
      test: 18,
      softSkillProject: 15.5,
  ...
  
    {
      ...
      dept: 'Hairdressing',
      phone: '(081) 521-06683',
      address: '8 OmilaniAgunbiade , Itire Ikate',
      weeklyAttendance: 7.5,
      softSkillAttendance: 10,
      test: 10,
      softSkillProject: 14.13,
  ...
  
    {
      ...
      dept: 'Hairdressing',
      phone: '(091) 681-87578',
      address: '219 Ijesha Road, Agulejika bus-stop, Itire Ikate',
      weeklyAttendance: 9.5,
      softSkillAttendance: 10,
      test: 13,
      softSkillProject: 7,
  ...
  
    {
      ...
      dept: 'Hairdressing',
      phone: '(080) 891-54484',
      address: '18 Ali Olatunji Sanusi, Itire / Ikate',
      weeklyAttendance: 3,
      softSkillAttendance: 0,
      test: 0,
      softSkillProject: 0,
  ...
  
    {
      ...
      dept: 'Hairdressing',
      phone: '(091) 640-42362',
      address: '14, Omounbi street Agunbiade , Itire/ Ikate',
      weeklyAttendance: 5,
    ...
    /////////////////////////////////////WEB DEVELOPMENT DEPARTMENT//////////////////////////////////////////
    {
      ...
      phone: '(090) 345-34003',
      address: '24, Aguntasolo street, Ijeshatedo Agunbiade , Itire/Ikate',
      weeklyAttendance: 10.0,
      softSkillAttendance: 10,
      test: 16,
      softSkillProject: 10,
  ...
  
    {
      ...
      dept: 'Web Development',
      phone: '(080) 899-93791',
      address: '13 Anjorin Street LawansonBaruwa, Itire-Ikate',
  ...
  
    {
      ...
      dept: 'Web Development',
      phone: '(080) 624-35258',
      address: '3 Aguntasolo street Agunbiade , Itire/Ikate',
      weeklyAttendance: 10.0,
      softSkillAttendance: 10,
      test: 19,
      softSkillProject: 10,
  ...
  
    {
      ...
      dept: 'Web Development',
      phone: '(080) 547-76662',
      address: '47 Adeboyeju street Odo- Olowu, Itire/ Ikate',
      weeklyAttendance: 9.25,
  ...
  
    {
      ...
      dept: 'Web Development',
      phone: '(070) 301-68084',
      address: '8 Gbadebo street Agunbiade , Itire /Ikate',
      weeklyAttendance: 9.75,
      softSkillAttendance: 10,
      test: 14,
      softSkillProject: 12,
  ...
  
    {
      ...
      dept: 'Web Development',
      phone: '(090) 746-50923',
      address: '72 tapa street Agunbiade , Itire / Ikate',
      weeklyAttendance: 8,
      softSkillAttendance: 5,
      test: 12,
      softSkillProject: 13,
  ...
  
    {
      ...
      dept: 'Web Development',
      phone: '(081) 236-14525',
      address: '7 Odunlami street Baruwa, Itire/Ikate',
      weeklyAttendance: 9.25,
      softSkillAttendance: 10,
      test: 16.6,
      softSkillProject: 11.63,
  ...
  
    {
      ...
      dept: 'Web Development',
      phone: '(090) 781-85955',
      address: '35 Eleru-idanusiAirways, Itire /Ikate',
      weeklyAttendance: 9.75,
      softSkillAttendance: 10,
      test: 19.7,
      softSkillProject: 12,
  ...
  
    {
      ...
      dept: 'Web Development',
      phone: '(080) 290-04235',
      address: '8 Ajia street Airways, Itire/ikate',
      weeklyAttendance: 8.75,
      softSkillAttendance: 10,
      test: 17.4,
      softSkillProject: 12,
  ...
  
    {
      ...
      dept: 'Web Development',
      phone: '(090) 336-77617',
      address: '2 olayinka street Sanusi, Itire/Ikate',
  ...
  
    {
      ...
      dept: 'Web Development',
      phone: '(090) 724-63355',
      address: '37, Alhaji Olakunle Street Agunbiade , Itire ikate',
      weeklyAttendance: 3,
      softSkillAttendance: 0,
      test: 0,
      softSkillProject: 0,
  ...
  
    {
      ...
      dept: 'UI/UX Design',
      phone: '(070) 346-51269',
      address: '92 Adeshina street Airways, Itire / Ikate',
      weeklyAttendance: 7,
      softSkillAttendance: 0,
      test: 0,
      softSkillProject: 0,
  ...
  
    {
      ...
      dept: 'UI/UX Design',
      phone: '(070) 407-19048',
      address: '1 surulere street baruwa, Itire/Ikate',
      weeklyAttendance: 6.75,
  ...
  
    {
      ...
      dept: 'UI/UX Design',
      phone: '(070) 666-50853',
      address: '10 savage lane orile Iganumu Savage',
      weeklyAttendance: 9.25,
      softSkillAttendance: 0,
      test: 13,
      softSkillProject: 14.13,
  ...
  
    {
      ...
      dept: 'UI/UX Design',
      phone: '(090) 369-42820',
      address: '54, Tapa street Airways , Itire/Ikate',
  ...
  
    {
      ...
      dept: 'UI/UX Design',
      phone: '(081) 665-88550',
      address: '31, Ramlat timson streetsanya, Cooker',
      weeklyAttendance: 9.5,
      softSkillAttendance: 10,
      test: 13,
      softSkillProject: 11.63,
